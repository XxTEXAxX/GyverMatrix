...
public partial class SettingsPage
{
    ...
    private async void AutoCheck1_Clicked(
        object sender,
        EventArgs e)
    {
        await SetAuto();
    ...
    private async void AutoCheck3_Clicked(
        object sender,
        EventArgs e)
    {
    ...
    private async void NetSet1_Clicked(
        object sender,
        EventArgs e)
    {
    ...
    private async void AutoSwitch_PropertyChanged(
        object sender,
        PropertyChangedEventArgs e)
    {
        string mode;
